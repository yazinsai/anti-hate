  ...
  return (
    <main>
      ...
      <div className={"p-3"}>
        ...
        <div className={"mt-14"}>
          <Company name={"Procter & Gamble"} haters={15} logo={"https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Procter_%26_Gamble_logo.svg/1280px-Procter_%26_Gamble_logo.svg.png"} />
          <div className={"flex gap-2 overflow-x-auto pb-4"}>
            <Post role={"Fulfilment Analyst"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit."} logo={"https://www.choosingtherapy.com/wp-content/uploads/2021/11/Dr-Tanveer-Ahmed.jpg"}></Post>
            <Post role={"Fulfilment Analyst"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit."} logo={"https://www.choosingtherapy.com/wp-content/uploads/2021/11/Dr-Tanveer-Ahmed.jpg"}></Post>
            <Post role={"Fulfilment Analyst"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit."} logo={"https://www.choosingtherapy.com/wp-content/uploads/2021/11/Dr-Tanveer-Ahmed.jpg"}></Post>
          </div>
        </div>
